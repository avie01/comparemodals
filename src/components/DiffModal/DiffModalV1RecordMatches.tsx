...
import { DiffTreeV1RecordMatches } from './DiffTreeV1RecordMatches';
import { VersionSelector } from './VersionSelector';
import fileDocumentIcon from '../../assets/file-document.svg';

export interface DiffModalV1RecordMatchesProps {
...
export function DiffModalV1RecordMatches({
  isOpen,
  onClose,
  title,
  subtitle,
